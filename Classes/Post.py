...
class Post:
    ...
    def __init__(self, user_id):
        self.postObj = vk_session.method('wall.get', {'owner_id': user_id, 'offset': 0, 'count': 10})
    ...
    def updatePostArr(self, offset):
        self.postObj = vk_session.method('wall.get', {'owner_id': self.user_id, 'offset': offset, 'count': 10})
